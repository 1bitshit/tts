...
import { API_DOCS, type ApiSubTab, type ApiParam, type ApiHeader, type ApiEndpoint, type ApiAdditionalEndpoint } from '../../config/apiDocs';
import { syntaxHighlightJSON } from '../../utils/syntaxHighlight';
import { useCopyToClipboard } from '../../hooks/useCopyToClipboard';
import { TabId } from '../../context/AppContext';
...
export function ApiDocsPanel({ isOpen, onClose, activeTab }: ApiDocsPanelProps) {
  ...
  const renderMainContent = () => {
    if (docs.subTabs) {
      const currentSubTab = docs.subTabs.find((st: ApiSubTab) => st.id === activeSubTab);
      return (
        <>
